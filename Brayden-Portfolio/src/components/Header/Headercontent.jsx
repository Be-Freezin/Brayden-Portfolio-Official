  ...
  return (
    <div className="mx-auto flex h-screen flex-col items-center justify-center ">
      ...
      <div className="lg:min-h-96 relative mx-auto  mt-64 flex h-72 w-96 flex-col items-center justify-center rounded-2xl border-4 border-bordermain shadow-0xl shadow-borderglow lg:h-full lg:w-3/5 lg:max-w-7xl ">
        ...
        <h1 className=" z-20  mt-16 font-handcraftChalk text-4xl lg:text-9xl text-skin-base ">
          Brayden Friesen
        </h1>
        <div className="z-20  mt-6 mr-20 lg:mr-96 font-bitechalknormal text-skin-base lg:text-2xl ">
      ...
      {/* END GLOW BOX */}
      <img
        className="mx-auto mt-36 animate-bounce"
        src={Arrow}
        alt=""
        srcset=""
      />
