		...
		<div id='about' className='flex flex-col justify-center  '>
			<div className='flex flex-col-reverse items-center  justify-center md:flex-row-reverse'>
				<div className='flex flex-col items-center justify-center md:w-1/2   '>
					<h2 className='mx-auto my-5  w-fit font-handcraftChalk text-5xl text-skin-accent lg:text-8xl'>
						Get to know me
					</h2>
					<Aboutbio />
				</div>
			...
			<div className='mx-auto grid w-5/6  grid-cols-3  items-center justify-evenly gap-4 md:flex    '>
				{interestsElements}
			</div>
		</div>
	)
