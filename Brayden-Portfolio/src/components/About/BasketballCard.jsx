...
const BasketballCard = ({ basketballIsShown, setBasketballIsShown }) => {
  return (
    ...
    >
      ...
      {basketballIsShown && (
        <div className="absolute bottom-0 right-0 flex h-96 w-64 flex-col  justify-evenly   rounded-md bg-gradient-to-b from-red-600  to-blue-500 p-1 text-center shadow-0xl shadow-mutedglow">
