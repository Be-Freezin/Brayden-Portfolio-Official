...
const Aboutbio = () => {
  return (
    <div className="mx-auto mb-10 w-full px-6 text-lg lg:mx-0 lg:mb-0 lg:w-1/2 lg:text-xl ">
      <p className="mx-auto text-center  font-bitechalknormal text-skin-base lg:mx-auto lg:w-4/6 ">
        Hey, I’m <span className="text-skin-accent">Brayden!</span> An ambitious Front End Developer who's
        been building my web development chops for over a year. Armed with a
        never-ending curiosity and an insatiable appetite for learning, I’ve
        been carving my way through the digital jungle!
      </p>
      <br />
      <p className="mx-auto text-center  font-bitechalknormal text-skin-base lg:mx-auto lg:w-4/6 ">
