...
const AudioCard = ({ audioIsShown, setAudioIsShown }) => {
  return (
    <div className="relative flex h-20 w-20 flex-col items-center justify-center rounded-md p-2 font-bitechalknormal text-sm text-skin-base  shadow-0xl shadow-mutedglow"
    ...
    >
      ...
      {audioIsShown && (
        <div className="absolute bottom-0 right-0 flex h-96 w-64 flex-col  justify-evenly   rounded-md bg-codehover p-1 text-center shadow-0xl shadow-codehover">
          <div className="flex h-full  w-full flex-col justify-evenly bg-skin-bg ">
            ...
            <p className="flex px-4 h-full flex-col justify-evenly text-lg">
