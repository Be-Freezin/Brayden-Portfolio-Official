...
const InterestsCards = ({ cardtitle, item, maintitle, icon, index }) => {
	...
	return (
		<div
			className='relative mx-auto flex h-24 w-24 flex-col items-center justify-center rounded-md bg-skin-bg p-2 font-bitechalknormal text-lg text-skin-base shadow-0xl shadow-mutedglow md:h-32  md:w-32 md:text-xl '
			index={index}
			key='id'
			onMouseEnter={() => setIsShown(true)}
			onMouseLeave={() => setIsShown(false)}
		>
			<div className='mx-auto flex h-5/6 flex-col justify-around text-center  '>
